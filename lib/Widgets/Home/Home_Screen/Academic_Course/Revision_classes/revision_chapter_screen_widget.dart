...
import 'package:education_on_cloud/Views/Screens/Home/Acadamic_Course/Revision_Classes/revison_classes_screen.dart';
...
class RevisionChapterScreenWidget {
          ...
          Row(
            children: [
              ...
              SizedBox(
                width: screenWidth * .7,
                child: CustomText(
                    text: '$titleOfChapter Revision Classes',
                    textStyle: GoogleFonts.inter(
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => AcademicRevisionVideoClass(
                            courseId: courseId,
