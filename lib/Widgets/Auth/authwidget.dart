...
class CustomTextFeild extends StatelessWidget {
  final String text;final IconData iconData;
  final TextEditingController controller;
  final TextCapitalization textCapitalization;
  TextInputType keybordtype;
  final String? Function(String?)? validator;
  
    CustomTextFeild({super.key, required this.text, required this.iconData, required this.controller, this.validator, required this.textCapitalization,this.keybordtype = TextInputType.name,});
